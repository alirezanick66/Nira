...
def main() -> None:
    ...
    test_cases = [
          #"سلام خوبی؟",
        "یه گوشی  ارزون میخوام برای عکاسی",
        "گوشی گیمینگ با رم بالا زیر 30 میلیون تومان",
        "بین آیفون 15 و سامسونگ S24 کدوم بهتره؟",
          #  "یه چیز گرونتر ولی با باتری قویتر نشون بده",
          #   "دوربین عالی برای عکاسی شب و قیمت مناسب",
          #  "گوشی سامسونگ یا شیائومی با باتری قوی",
          #  "موبایل بین 10 تا 20 میلیون",
          #   "زیر ۳۰ میلیون",
          #  "رم حداقل 8 گیگ و حافظه بالای 128",
          #   "سامسونگ با دوربین عالی",
          # "گوشی زیر ۲۰ میلیون",
