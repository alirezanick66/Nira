...
**📍 وضعیت فعلی پروژه**: ✅ پایان فاز `MVP Refinement` | 🟢 تکمیل زیرساخت آنالیتیکس و دمو B2B
...
- [x] **موتور استخراج LLM (Extract)**: نرمال‌سازی فارسی +تشخیص نیت، فیلترها و semantic_query + Fast-Path Greeting (<۱ms، بدون مصرف توکن)
...
- [x] **Context-Aware Memory**: تزریق تاریخچه + فیلترهای قبلی به پرامپت برای Refine هوشمند
...
|              فیچر               |                                                       توضیح                                                        |  اولویت  |                                         وابستگی‌ها                                         |                                           معیار موفقیت                                           |
| :-----------------------------: | :----------------------------------------------------------------------------------------------------------------: | :------: | :----------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------------: |
|  **🔍 Intent Compare Engine**   |                                            تولید متن تحلیلی بین ۲ محصول                                            | ✅ تکمیل  |                       `LLM Orchestrator` + Structured Output Schema                        |                                       تولید پاسخ توسط LLM                                        |
...
- [x] ماژول‌های فرانت‌اند ایزوله: `admin-api.js`, `admin-ui.js`, `admin.js` + استایل‌های `04-admin.css`
- [x] رندر پویا جدول، pagination، badge وضعیت، تگ‌های فیلتر خوانا، چارت‌های Chart.js (Bar/Pie) و Skeleton Loading
