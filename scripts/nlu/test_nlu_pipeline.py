...
def main() -> None:
    ...
    test_cases = [
        ...
        "دوربین عالی برای عکاسی شب و قیمت مناسب", "گوشی سامسونگ یا شیائومی با باتری قوی", "موبایل بین 10 تا 20 میلیون",
        "زیر ۳۰ میلیون", "رم حداقل 8 گیگ و حافظه بالای 128", "سامسونگ با دوربین عالی", "گوشی زیر ۲۰ میلیون",
        "یه گوشی خوب برای اینستاگرام و فیلمبرداری"
    ]
