...
class Settings( BaseSettings ):
    ...
    RERANKER_MIN_SCORE: float = Field( default=0.0, ge=0.0, le=1.0, description="حداقل امتیاز Sigmoid برای پذیرش یک نتیجه در Top-k" )
    ...
    GROQ_TIMEOUT_SEC: float = Field( default=10.0, gt=0.0 )
