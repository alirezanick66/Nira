...
class DigikalaSyncService:
    ...
    async def run( self, max_products: int | None = None, checkpoint_every: int = 5 ) -> int:
        ...
        log_message( LG.DATA_PROCESSING, f"شروع همگام‌سازی | ادامه از ID: {last_id} | صفحه: {start_page}", LogLevel.INFO )
